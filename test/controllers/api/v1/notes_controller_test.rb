...
class Api::V1::NotesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create note" do
    assert_difference('Api::V1::Note.count') do
      post notes_url, params: { note: { assessment_id: @note.assessment_id, user_id: @note.user_id, note: @note.note } }, as: :json
    end
  ...
  test "should update note" do
    patch note_url(@note), params: { note: { assessment_id: @note.assessment_id, user_id: @note.user_id, note: @note.note } }, as: :json
    assert_response 200
  end
